...
class Empleado extends ActiveRecord{
    ...
    public static $columnasDB = ['empleado_nombre','empleado_dpi','empleado_id_puesto','empleado_edad','empleado_sexo','empleado_id_area','empleado_situacion'];
    public static $idTabla = 'empleado_id';

    public $empleado_id;
    public $empleado_nombre;
    public $empleado_dpi;
    public $empleado_id_puesto;
    ...
    public function __construct($args =[])
    {
        ...
        $this->empleado_id_puesto = $args['empleado_id_puesto'] ?? '';
