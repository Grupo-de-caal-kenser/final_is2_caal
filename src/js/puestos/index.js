...
const guardar = async (evento) => {
    ...
    const url = '/final_is2_caal/API/puestos/guardar';
    const config = {
        method : 'POST',
        // body: otroNombre
        body
...
const buscar = async () => {
    ...
    const url = `/final_is2_caal/API/puestos/buscar?puesto_descripcion=${puesto_descripcion}&puesto_sueldo=${puesto_sueldo}`;
    const config = {
        method : 'GET'
    }
...
const modificar = async () => {
    ...
    const body = new FormData(formulario)
    const url = `/final_is2_caal/API/puestos/modificar?puesto_id=${puesto_id}`;
    const config = {
        method : 'POST',
        body
    }
...
const eliminar = async (id) => {
    ...
    const url = '/final_is2_caal/API/puestos/eliminar';
